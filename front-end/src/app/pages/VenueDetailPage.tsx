...
import VenueDetail from '../components/detail-categories/VenueDetail';
...
export default function VenueDetailPage({ item }: Props) {
  ...
  return (
    <>
      <ItemDetailShell
        ...
        content={<VenueDetail item={item} textClassName="text-[#875A6B]" />}
        sidebar={
          <DetailSidebar
            item={item}
            ...
            onBook={() => navigate(`/book/venue/${item.id}`)}
          />
        }
      />
